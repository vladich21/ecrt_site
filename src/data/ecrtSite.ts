...
export const strategicProjects: StrategicProjectData[] = [
  {
    ...
    teaser:
      'Создание математической модели контактной сети и динамического токосъема подвижным составом - для проектирования и эксплуатации на РЖД, включая первую линию ВСМ Москва - Санкт-Петербург.',
    value:
    ...
    description:
      'Модель описывает динамику контактной подвески и процесс взаимодействия с токоприемниками. Применима при разработке технических решений, проектировании и эксплуатации контактной сети на электрифицированных участках сети ОАО «РЖД», в том числе на первой линии ВСМ Москва - Санкт-Петербург.',
    bullets: [
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'Используется при разработке технических решений, проектировании и эксплуатации контактной сети на всех электрифицированных участках сети железных дорог ОАО «РЖД», в том числе на первой линии ВСМ Москва - Санкт-Петербург.',
        ],
      },
      {
        title: 'Визуализация: прототип токоприемника первого отечественного высокоскоростного электропоезда и подвеска КС-400',
        paragraphs: [
          'На представленных иллюстрациях показано моделирование взаимодействия прототипа токоприемника первого отечественного высокоскоростного электропоезда с контактной подвеской КС-400.',
        ],
      },
    ],
    details: [],
